#!/bin/bash
#job name
#SBATCH --job-name=epi_model_calibration_resource_allocation_SA
#SBATCH --account=icrc
...
## set array
#SBATCH --array=1-500 #number_of_general_param_sets
########SBATCH --array=708,804,2015,2019,2023,2024,2027,2029,2030,2035,2045

module load apptainer

apptainer run --bind /gscratch/icrc/cgreene3/SA_resource_allocation /gscratch/icrc/cgreene3/SA_resource_allocation warmup_calibration_runs_image.sif $SLURM_ARRAY_TASK_ID
